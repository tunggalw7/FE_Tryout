...
@Component({
  selector: 'quiz-siswa-ips',
  styleUrls: ['./quiz-siswa-ips.component.scss'],
  templateUrl: './quiz-siswa-ips.component.html',
})

export class QuizSiswaIPSComponent implements OnDestroy, OnInit {
    ...
    this.themeSubscription = this.theme.getJsTheme().subscribe(config => {
      ...
      this.options =  {
        ...
        xAxis: [
            {
                type: 'category',
                data: ['TRYOUT 1', 'TRYOUT 2', 'TRYOUT 3', 'TRYOUT 4', 'TRYOUT 5', 'TRYOUT 6'],
                axisPointer: {
                    type: 'shadow'
                }
            }
        ...
        series: [
            {
                name: 'Nilai',
                type: 'bar',
                data: [48.24, 41.18, 41.18, 35.63, 48.13, 45.63],
                label: {
                    show: true,
                    position: 'top',
                    color: '#000'
