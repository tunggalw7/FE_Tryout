...
@Component({
  selector: 'dashboard-siswa-ipa',
  styleUrls: ['./dashboard-siswa-ipa.component.scss'],
  templateUrl: './dashboard-siswa-ipa.component.html',
})

export class DashboardSiswaIPAComponent implements OnDestroy, OnInit {
