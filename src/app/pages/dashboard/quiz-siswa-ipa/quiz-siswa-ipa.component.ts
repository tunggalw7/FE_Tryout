...
@Component({
  selector: 'quiz-siswa-ipa',
  styleUrls: ['./quiz-siswa-ipa.component.scss'],
  templateUrl: './quiz-siswa-ipa.component.html',
})

export class QuizSiswaIPAComponent implements OnDestroy, OnInit {
