...
@Component({
  selector: 'absensi-siswa-ips',
  styleUrls: ['./absensi-siswa-ips.component.scss'],
  templateUrl: './absensi-siswa-ips.component.html',
})

export class AbsensiSiswaIPSComponent implements OnDestroy, OnInit {
