...
@Component({
  selector: 'dashboard-siswa-ips',
  styleUrls: ['./dashboard-siswa-ips.component.scss'],
  templateUrl: './dashboard-siswa-ips.component.html',
})

export class DashboardSiswaIPSComponent implements OnDestroy, OnInit {
  ...
  ngOnInit() {    
    ...
    // if (this.route.snapshot.params.nis != null) {
      ...
      this.nis = this.currentUser.no_induk;
      var d = new Date();
