...
@Component({
  selector: 'delete-siswa',
  styleUrls: ['./delete-siswa.component.scss'],
  templateUrl: './delete-siswa.component.html',
})
export class DeleteSiswaComponent implements OnDestroy, OnInit {
    dataForm: any;
    submitLoading: Boolean = false;
    baseService = "core/siswa";

    constructor(
      protected ref: NbDialogRef<DeleteSiswaComponent>,
