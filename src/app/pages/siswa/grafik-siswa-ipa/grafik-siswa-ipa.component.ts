...
@Component({
  selector: 'grafik-siswa-ipa',
  styleUrls: ['./grafik-siswa-ipa.component.scss'],
  templateUrl: './grafik-siswa-ipa.component.html',
})

export class GrafikTOIpaSiswaComponent implements OnDestroy, OnInit {
