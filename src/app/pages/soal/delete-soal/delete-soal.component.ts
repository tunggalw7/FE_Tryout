...
@Component({
  selector: 'delete-soal',
  styleUrls: ['./delete-soal.component.scss'],
  templateUrl: './delete-soal.component.html',
})
export class DeleteSoalComponent implements OnDestroy, OnInit {
    dataForm: any;
    submitLoading: Boolean = false;
    baseService = "core/soal";

    constructor(
      protected ref: NbDialogRef<DeleteSoalComponent>,
