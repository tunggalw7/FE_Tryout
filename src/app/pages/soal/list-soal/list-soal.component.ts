...
export class ListSoalComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.rows = dummy["payload"]["data"]; 
    this.page.totalItems = Number(dummy["payload"]["meta"].totalItems);
  ...
  addUser() {
    this.dialogService
    .open(AddEditSoalComponent, { closeOnBackdropClick: false })
