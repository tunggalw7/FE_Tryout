...
@Component({
  selector: "list-universitas",
  templateUrl: "./list-universitas.component.html",
  styleUrls: ["./list-universitas.component.scss"],
})
export class ListUniversitasComponent implements OnInit {
  actionSelect: String;
  ...
  addUser() {
    this.dialogService
    .open(AddEditUniversitasComponent, { closeOnBackdropClick: false })
  ...
  editUser(data) {
    this.dialogService
      .open(AddEditUniversitasComponent, {
  ...
  deleteUser(data) {
    this.dialogService
      .open(DeleteUniversitasComponent, {
        closeOnBackdropClick: false,
        context: {
          dataForm: data,
        },
